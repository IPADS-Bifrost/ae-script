...
class MemtierTestSuite1:
    ...
    breakdown_types = ["vobd-0", "vobd-2", "nobd-2", "vgobd-2", "ngobd-2"]
    ...
    def draw(cls, test_type, relative=True):
        ...
        for machine in cls.breakdown_types:
            ...
            file_name = "amd-memtier-{}-breakdown-guest.stat".format(machine)
            path = "../../../data/" + ('' if test_type == 'redis' else '') + file_name
            total_guest=0.0
            netrx=0.0
            tcp_send=0.0
            ...
            file_name = "amd-memtier-{}-breakdown-host.stat".format(machine)
            path = "../../../data/" + ('' if test_type == 'redis' else '') + file_name
            total_host=0.0
            cycles=0.0
