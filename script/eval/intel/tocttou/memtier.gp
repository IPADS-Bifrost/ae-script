#!/usr/bin/gnuplot
reset
set output "../../../../figures/fig-12-a.eps"
set terminal postscript "Helvetica" eps enhance dl 2 color size 5.2,3
set pointsize 1
...
set ylabel "Overhead" offset -8,0 font ",40"
set xlabel font ",34" offset 0,0.5
set label "1vCPU" offset 1,-9 font ",50"
set label "4vCPU" offset 26,-9 font ",50"
set format y "%g%%"
set yrange[0:2]
set ytics 0,0.5,2 font ",40"
set grid ytics lw 2
...
plot newhistogram "",\
     'res/memtier.res'   u 2:xtic(1)   lc rgb '#C6DBEF' lw 4 ,\