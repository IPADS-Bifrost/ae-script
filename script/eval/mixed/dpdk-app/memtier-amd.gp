#!/usr/bin/gnuplot
reset
set output "../../../../figures/fig-07-a.eps"
...
set label "1vCPU" offset 0,-7 font ",30"
set label "4vCPU" offset 25,-7 font ",30"

# y-axis
set ylabel "Overhead" offset -4,0 font ",32"
set yrange[-15:25]
set ytics -30, 10, 30 font ",28"
set grid ytics lw 2
set format y "%g%%"
...
# redline
set arrow 1 from 1.5,-25 to 1.5,30 nohead lc "red" front
set arrow 1 dt 6

plot newhistogram "",\
     'res/memtier.res'   u 2:xtic(1)  ti col lc rgb '#C6DBEF' lw 4 ,\
     'res/memtier.res'   u 3:xtic(1)  ti col lc rgb '#6BAED6' lw 4, \
     'res/memtier.res'   u 4:xtic(1)  ti col lc rgb '#2171B5' lw 4, \
     'res/memtier.res'   u 5:xtic(1)  ti col lc rgb '#084594' lw 4,\