# #!/usr/bin/gnuplot
# reset
# set output "../../../../figures/fig-08-c.eps"
...
# set label "4vCPU" offset 27,-8 font ",30"
# 
# # y-axis
# # set ylabel "Relative Overhead" offset -5,0 font ",32"
# set yrange[-20:25]
# set ytics -20, 10, 25 font ",28"
# set grid ytics lw 2
# set format y "%g%%"
...
# 
# # redline
# set arrow 1 from 1.5,-30 to 1.5,35 nohead lc "red" front
# set arrow 1 dt 6
# 
# plot newhistogram "",\
#      'res/redis.res'   u 6:xtic(1)  ti col lc rgb '#C6DBEF' lw 4 ,\
#      'res/redis.res'   u 7:xtic(1)  ti col lc rgb '#6BAED6' lw 4, \
#      'res/redis.res'   u 8:xtic(1)  ti col lc rgb '#2171B5' lw 4, \
#      'res/redis.res'   u 9:xtic(1)  ti col lc rgb '#084594' lw 4,\
...
#set xtics norangelimit
set label "1vCPU" offset 0,-8 font ",28"
set label "4vCPU" offset 26,-8 font ",28"

# y-axis
set yrange[-20:20]
set format y "%g%%"
set ytics -20, 10, 20 font ",26"
set grid ytics lw 2
set offset -0.4,-0.4,0,0
...
# redline
set arrow 1 from 1.5,-30 to 1.5,25 nohead lc "red" front
set arrow 1 dt 6
