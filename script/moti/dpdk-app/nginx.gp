#!/usr/bin/gnuplot
reset
set output "../../../figures/fig-02-b.eps"
...
##
# unset key
# set key outside right Left reverse enhanced autotitles columnhead nobox font ",25"
...
# set label "2.20X" font ",22" left   at   1.16,2.02
...
plot newhistogram "",\
     ...
     'res/nginx.res'   u 3:xtic(1)  ti col lc rgb '#2171B5' lw 4
